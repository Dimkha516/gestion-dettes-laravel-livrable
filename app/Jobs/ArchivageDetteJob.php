...
use App\Services\ArchivageFactory;
use DB;
...
class ArchivageDetteJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        // Créer le service d'archivage
        $archivageService = ArchivageFactory::create();

        // Archiver et supprimer chaque dette
        foreach ($dettesSoldees as $dette) {
            $archivageService->archiverDette($dette);
            $archivageService->supprimerDette($dette->id);
        }
